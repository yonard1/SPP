    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('admin.transaksi.index') }}" class="btn btn-secondary btn-sm w-100">↩️ Kembali</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.transaksi.store') }}" method="POST" id="formPembayaran">
                    @csrf
